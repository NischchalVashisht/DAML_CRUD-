...
package com.knoldus.model {
  package Main {
    final case class Product(authority: ` lfdomainapi`.Primitive.Party, wholesaler: ` lfdomainapi`.Primitive.Party, consumer: ` lfdomainapi`.Primitive.Party, name: ` lfdomainapi`.Primitive.Text) extends ` lfdomainapi`.Template[Product] {
      override protected[this] def templateCompanion(implicit ` d` : _root_.scala.Predef.DummyImplicit) = Product
    }

    object Product extends ` lfdomainapi`.TemplateCompanion[Product] with _root_.scala.Function4[` lfdomainapi`.Primitive.Party, ` lfdomainapi`.Primitive.Party, ` lfdomainapi`.Primitive.Party, ` lfdomainapi`.Primitive.Text, _root_.com.knoldus.model.Main.Product] {
      import _root_.scala.language.higherKinds;
      trait view[` C`[_]] extends ` lfdomainapi`.encoding.RecordView[` C`, view] { $u0020view =>
        val authority: ` C`[` lfdomainapi`.Primitive.Party];
        ...
        final override def hoist[` D`[_]](` f` : _root_.scalaz.~>[` C`, ` D`]): view[` D`] = {
          final class $anon extends _root_.scala.AnyRef with view[` D`] {
            override val authority = ` f`(` view`.authority);
      ...
      final implicit class `Product syntax`[+` ExOn`](private val id: ` ExOn`) extends _root_.scala.AnyVal {
        ...
        def exerciseTransfer(actor: ` lfdomainapi`.Primitive.Party, newOwner: ` lfdomainapi`.Primitive.Party)(implicit ` exOn` : ` lfdomainapi`.encoding.ExerciseOn[` ExOn`, Product]): ` lfdomainapi`.Primitive.Update[` lfdomainapi`.Primitive.ContractId[com.knoldus.model.Main.TransferOwnership]] = exerciseTransfer(actor, _root_.com.knoldus.model.Main.Transfer(newOwner));
      ...
      override def toNamedArguments(` self` : Product) = ` arguments`(scala.Tuple2("authority", ` lfdomainapi`.Value.encode(` self`.authority)), scala.Tuple2("wholesaler", ` lfdomainapi`.Value.encode(` self`.wholesaler)), scala.Tuple2("consumer", ` lfdomainapi`.Value.encode(` self`.consumer)), scala.Tuple2("name", ` lfdomainapi`.Value.encode(` self`.name)));
      override def fromNamedArguments(` r` : ` rpcvalue`.Record) = if (` r`.fields.length.==(4))
        ` r`.fields(0) match {
          case ` rpcvalue`.RecordField((""| "authority"), _root_.scala.Some(zv0)) => (` lfdomainapi`.Value.decode[` lfdomainapi`.Primitive.Party](zv0) match {
                  ...
                  case ` rpcvalue`.RecordField((""| "consumer"), _root_.scala.Some(zv2)) => (` lfdomainapi`.Value.decode[` lfdomainapi`.Primitive.Party](zv2) match {
                    case _root_.scala.Some(z2) => (` r`.fields(3) match {
                      case ` rpcvalue`.RecordField((""| "name"), _root_.scala.Some(zv3)) => (` lfdomainapi`.Value.decode[` lfdomainapi`.Primitive.Text](zv3) match {
                        case _root_.scala.Some(z3) => Some(Product(z0, z1, z2, z3))
      ...
      override def fieldEncoding(lte: ` lfdomainapi`.encoding.LfTypeEncoding): view[lte.Field] = {
        object `view ` extends view[lte.Field] {
          val authority = lte.field("authority", ` lfdomainapi`.encoding.LfEncodable.encoding[` lfdomainapi`.Primitive.Party](lte));
      ...
      override def encoding(lte: ` lfdomainapi`.encoding.LfTypeEncoding)(`view `: view[lte.Field]): lte.Out[_root_.com.knoldus.model.Main.Product] = {
        val `recordFields `: lte.RecordFields[_root_.com.knoldus.model.Main.Product] = lte.RecordFields.xmapN(lte.fields(`view `.authority), lte.fields(`view `.wholesaler), lte.fields(`view `.consumer), lte.fields(`view `.name))({
          case scala.Tuple4(authority, wholesaler, consumer, name) => _root_.com.knoldus.model.Main.Product(authority, wholesaler, consumer, name)
        })({
          case _root_.com.knoldus.model.Main.Product(authority, wholesaler, consumer, name) => scala.Tuple4(authority, wholesaler, consumer, name)
        });
